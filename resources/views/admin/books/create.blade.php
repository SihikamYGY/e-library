        ...
        <div class="bg-white p-6 rounded-xl shadow-sm">
            ...
            <form action="{{ route('admin.books.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid gap-4">
                    ...
                    <input type="text" name="publisher" placeholder="Publisher" value="{{ old('publisher') }}"
                        class="{{ $inputClass }}">
                    ...
                    <textarea name="synopsis" placeholder="Synopsis" class="{{ $inputClass }} h-28"></textarea>

                    {{-- COVER --}}
                    <div>
                        <input type="file" id="coverInput" name="cover" class="{{ $inputClass }}">

                        <img id="previewImage" class="mt-3 w-24 h-32 object-cover rounded-lg hidden">
                    </div>
